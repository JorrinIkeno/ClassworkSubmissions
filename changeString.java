...
public class DiceRoller
{
	...
	{	
		...
		//Create an if statement to account for Strings with different
		//amounts of spaces.
		if(s < 2)
		{
			...
			String beforeSpace = userString.substring(0,space);
			
			//Store the characters after ' ' in another String.
			String afterSpace = userString.substring(space + 1);
			
			//Concatenate beforeSpace and afterSpace and assign them to one String.
			userString = beforeSpace.concat(afterSpace);
